  ...
  const handleCreate = async (e: { preventDefault: () => void }) => {
    ...
    if (data) {
      Swal.fire({
        ...
        background: `${themeBackground}`,
        color: `${themeColor}`,
        title: "You've succesfully created a new delivery type!",
      ...
      {isAdmin ?
        <div className={`admin-display ${theme === "light" ? "light-bg black-font" : "dark-toned-bg white-font"}`}>
          ...
          <div style={{ display: "flex", gap: "20px", alignItems: "center" }}>
            <button style={{ height: "60px" }} className={`admin-button ${theme === "light" ? "light-var-bg" : "dark-var-bg"}`} onClick={(e) => handleCreate(e)}>Add new delivery type</button>
            <Link to="/admin">
